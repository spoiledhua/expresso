...
import { Menu, Icon, Image, Container, Header, Grid, Dimmer, Loader, Item, Responsive, Card, Button, Modal } from 'semantic-ui-react';
                    ...
                    <Grid.Row>
                      ...
                      <Grid.Column width='15'>
                        ...
                        <Grid>
                          ...
                          <Grid.Row >
                            <Header style={{'fontSize':'2em', fontFamily:'Avenir'}}>DRINKS</Header>
                          </Grid.Row>
                          <Grid.Row>
                            <Grid.Column width='1' />
                            <Grid.Column width='15'>
                          ...
                          <Grid.Row>
                            <Header style={{fontSize: '2em', fontFamily:'Avenir'}}>FOOD</Header>
                          </Grid.Row>
                          <Grid.Row>
                            <Grid.Column width='1' />
                            <Grid.Column width='15'>
